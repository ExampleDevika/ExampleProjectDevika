...
read -r PROJECT_NAME
sed -i '' -e "s|example-app-devika|$PROJECT_NAME|g" ./scripts/project-variables.sh >/dev/null 2>&1
sed -i '' -e "s|example-app-devika|$PROJECT_NAME|g" ./scripts/setup.sh >/dev/null 2>&1
echo
